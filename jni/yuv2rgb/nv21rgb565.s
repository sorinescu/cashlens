...
.text
.global nv21_2_rgb565
.type nv21_2_rgb565, %function

@ void nv21_2_rgb565
@  uint8_t *dst_ptr
@  uint8_t *y_ptr
@  uint8_t *uv_ptr
@  uint8_t *v_ptr <unused>
@  int      width
@  int      height
@  int      y_span
@  int      uv_span
...
xloop1:
	LDRB	r11,[r2], #1		@ r11 = u  = *uv_ptr++
	LDRB	r12,[r2], #1		@ r12 = v  = *uv_ptr++
...
trail_pair1:
	...
	LDRB	r11,[r2]		@ r11 = u  = *uv_ptr++
	LDRB	r12,[r2]		@ r12 = v  = *uv_ptr++
	LDRB	r7, [r1, r10]		@ r7  = y2 = y_ptr[stride]
	LDRB	r6, [r1], #1		@ r6  = y0 = *y_ptr++
	ADD	r11,r11,#256
	ADD	r12,r12,#512
